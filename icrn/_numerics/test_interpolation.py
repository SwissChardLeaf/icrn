    ...
    def test_exponential_decay(self):
        ...
        target = jnp.array(
            [
                ...
                y0 * jnp.exp(-a * 1)
                + (y0 * jnp.exp(-a * 1.5) - y0 * jnp.exp(-a * 1)) * 0.4,
                y0 * jnp.exp(-a * 3.5),
                y0 * jnp.exp(-a * 8.0)
                + (y0 * jnp.exp(-a * 8.5) - y0 * jnp.exp(-a * 8.0)) * 0.2,
            ]
        )
    ...
    def test_multi_dimensional_decay(self):
        ...
        target = jnp.array(
            [
                ...
                y0 * jnp.exp(-a * 1)
                + (y0 * jnp.exp(-a * 2) - y0 * jnp.exp(-a * 1)) * 0.2,
                y0 * jnp.exp(-a * 3)
                + (y0 * jnp.exp(-a * 4) - y0 * jnp.exp(-a * 3)) * 0.5,
                y0 * jnp.exp(-a * 8)
                + (y0 * jnp.exp(-a * 9) - y0 * jnp.exp(-a * 8)) * 0.1,
            ]
        )
