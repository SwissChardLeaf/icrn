...
class ExperimentTests(unittest.TestCase):
    ...
    def test_simulate_segments(self):
        ...
        last_concs, concs_hist = self.exp1.simulate_segments(
            concs_data=concs_data,
        ...
        rate_constant_data = SJDict(
            {
                ...
                beta: 2.0 * jnp.ones((3, 100, 100, 10)).astype("float32"),
            }
        )
        ...
        last_concs, concs_hist = self.exp2.simulate_segments(
            concs_data=concs_data,
            rate_constant_data=rate_constant_data,
            diff_data=diff_data,
            segments=5,
    ...
    def test_simulate_time(self):
        ...
        last_concs, concs_hist = self.exp1.simulate_time(
            concs_data=concs_data,
            rate_constant_data=rate_constant_data,
            diff_data={},
            time=1,
        ...
        last_concs, concs_hist = self.exp2.simulate_time(
            concs_data=concs_data,
            rate_constant_data=rate_constant_data,
            diff_data=diff_data,
            time=10,
    ...
    def test_dict_builder(self):
        ...
        diff_spec = {A: 0.1, C: 0.2}

        concs_data, rate_constant_data, diff_data = self.exp2.dict_builder(
            concs_spec=concs_spec,
            rate_constant_spec=rate_constant_spec,
            diff_spec=diff_spec,
            batch_size=3,
            ...
            SJDict(
                {
                    ...
                    beta: 2.0 * jnp.ones((3, 100, 100, 10)),
                }
            ),
        )
